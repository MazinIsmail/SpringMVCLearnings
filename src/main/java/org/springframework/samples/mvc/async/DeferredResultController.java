...
/*
***************Need further learning for this class**************

At a high level view, Callable and DeferredResult do the same exact thing,
which is releasing the container thread and processing the long running task asynchronously in another thread.
The difference is in who manages the thread executing the task.
